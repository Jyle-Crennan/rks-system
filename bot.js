...
client.on('message', msg => {
  ...
  const helplist = new Discord.RichEmbed()
    ...
    .addField("**>flip** or **>roll**", "> These commands act as randomizers. Whether you need to flip a coin and make a decision that way, or you just need a random number generator in the form of a die, these commands have you covered!")
    .addField("**>help**", "> You're already looking at the command list, but if you didn't know, this command takes you to this very message. All of the commands that RKS follows are listed here.")
